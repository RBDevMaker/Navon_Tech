...
export function AuthWrapper({ children }) {
    ...
    async function checkUser() {
        try {
            ...
            // If URL has #login, skip security warning and go straight to login
    ...
    // Welcome Guide - shows after first login to explain portal access
    if (showWelcomeGuide) {
        return (
            <div style={{
                position: 'fixed',
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{ color: 'rgba(255, 255, 255, 0.95)', fontSize: '0.95rem', lineHeight: '1.8' }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem', marginBottom: '0.75rem' }}>
                                ...
                                <span>Scroll to the bottom of the page and find the <strong style={{ color: '#d4af37' }}>🛡️ shield icon</strong> in the footer</span>
                            </div>
                            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem', marginBottom: '0.75rem' }}>
                    ...
                    <div style={{
                        ...
                        <p style={{ color: '#d4af37', fontSize: '0.85rem', margin: 0, fontWeight: '600' }}>
                            💡 Tip: You can also bookmark <strong>navontech.com/#portal</strong> for direct login access
                        </p>
                    </div>
